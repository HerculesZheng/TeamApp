...
<ul class="catalog">
  ...
  <li class="active"><router-link to="/wait_shouhuo">待收货</router-link></li>
...
<ul class="detail">
  ...
  <li>
   ...
   <span>￥13</span>
   <div class="flo_right">
     <router-link to="/sure_shop"><button class="zhifu">确定收货</button></router-link>
   </div>
  </li> 
</ul>
